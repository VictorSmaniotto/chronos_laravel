...
<div class="col-md-12">
    ...
    <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" required autocomplete="email" value="{{ old('email') }}" @error('email') aria-describedby="email-error" @enderror>
@error('email')
