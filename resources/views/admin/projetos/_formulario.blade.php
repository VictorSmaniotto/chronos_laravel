...
<div class="col-md-12">
    ...
    <input type="text" class="form-control @error('nome_projeto') is-invalid @enderror" name="nome_projeto"
        ...
        @error('nome_projeto') aria-describedby="nome_projeto_feedback" @enderror required>
    @error('nome_projeto')
        <div id="nome_projeto_feedback" class="invalid-feedback">
            {{ $message }}
        </div>
    @enderror
</div>
...
<div class="col-md-12">
    ...
    <textarea name="descricao" class="form-control @error('descricao') is-invalid @enderror" id="descricao"
        rows="4" @error('descricao') aria-describedby="descricao_feedback" @enderror required>{{ old('descricao', $projeto->descricao) }}</textarea>

    @error('descricao')
        <div id="descricao_feedback" class="invalid-feedback">
            {{ $message }}
        </div>
    @enderror
</div>
...
<div class="col-md-12">
    ...
    <textarea name="objetivo" class="form-control @error('objetivo') is-invalid @enderror" id="objetivo"
        rows="4" @error('objetivo') aria-describedby="objetivo_feedback" @enderror required> {{ old('objetivo', $projeto->objetivo) }} </textarea>
    @error('objetivo')
        <div id="objetivo_feedback" class="invalid-feedback">
            {{ $message }}
        </div>
    @enderror
</div>
...
<div class="col-md-12">
    ...
    @error('palavras_chave')
        <div id="palavras_chave_feedback" class="invalid-feedback">
            {{ $message }}
        </div>
    @enderror
</div>
...
<div class="col-md-4">
    ...
    <input type="date" class="form-control @error('data_criacao') is-invalid @enderror" id="data_criacao" name="data_criacao"
        value="{{ old('data_criacao', $projeto->data_criacao) }}" @error('data_criacao') aria-describedby="data_criacao_feedback" @enderror required>
    @error('data_criacao')
        <div id="data_criacao_feedback" class="invalid-feedback">
            {{ $message }}
        </div>
    @enderror
</div>
...
<div class="col-md-4">
    ...
    <select class="form-control @error('situacao') is-invalid @enderror" id="situacao" name="situacao" @error('situacao') aria-describedby="situacao_feedback" @enderror required>
    ...
    @error('situacao')
        <div id="situacao_feedback" class="invalid-feedback">
            {{ $message }}
        </div>
    @enderror
</div>
...
<div class="col-md-6">
    ...
    <select class="form-control @error('categoria_id') is-invalid @enderror" id="categoria_id" name="categoria_id" @error('categoria_id') aria-describedby="categoria_id_feedback" @enderror required>
    ...
    @error('categoria_id')
        <div id="categoria_id_feedback" class="invalid-feedback">
            {{ $message }}
        </div>
    @enderror
</div>
...
<div class="col-md-6">
    ...
    <select class="form-control @error('curso_id') is-invalid @enderror" id="curso_id" name="curso_id" @error('curso_id') aria-describedby="curso_id_feedback" @enderror required>
        <option value=""> Selecione </option>
    ...
    @error('curso_id')
        <div id="curso_id_feedback" class="invalid-feedback">
            {{ $message }}
        </div>
    @enderror
</div>
