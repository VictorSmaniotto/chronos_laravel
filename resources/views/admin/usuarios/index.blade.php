        ...
        <table class="table table-hover table-striped mt-3 align-middle">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="d-flex">
                    <a href="{{ route('admin.usuarios.visualizar',['id'=> $user->id ]) }}" class="btn btn-sm btn-info text-light me-2" aria-label="Visualizar {{ $user->nome }}"><i class="fas fa-eye"></i></a>
                    <a href="{{ route('admin.usuarios.editar',['id'=> $user->id ]) }}" class="btn btn-sm btn-primary" aria-label="Editar {{ $user->nome }}"><i class="fas fa-edit"></i></a>
                    <form action="{{ route('admin.usuarios.deletar', ['id' => $user->id]) }}" method="post">
                       ...
                       <button class="btn btn-danger btn-sm ms-2" onclick="return confirm('Deseja Deletar o Registro?')" type="submit"
                          name="Delete" aria-label="Deletar {{ $user->nome }}">
